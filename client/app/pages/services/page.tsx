...
import { Monitor, Smartphone, Cloud, Shield, Code, BarChart, Server, ShoppingCart, Globe } from 'lucide-react';
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-200 max-w-3xl mx-auto">
            We deliver end-to-end technology solutions that help businesses thrive in the digital
            age. From web development to cloud infrastructure, we've got you covered.
          </p>
        </div>
