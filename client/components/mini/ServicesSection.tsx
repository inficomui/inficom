// app/pages/services/ServicesPageClient.tsx
"use client";
  ...
  return (
    <>
      ...
      <section id="services" className="relative py-24 lg:py-32" ref={sectionRef}>
        {/* Background Gradient */}
        <div
          className={`absolute inset-0 bg-gradient-to-bl from-[${BLUE}] via-[${CENTER}] to-[${ORANGE}]`}
        />
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-200 max-w-3xl mx-auto">
              We deliver end-to-end technology solutions that help businesses thrive in the
              digital age. From web development to cloud infrastructure, we&apos;ve got you
              covered.
            </p>
          </div>
              ...
              data.map((service, index) => {
                ...
                return (
                  <CometCard key={service._id}>
                    <article
                      data-index={index}
                      className="group relative h-full rounded-2xl p-5 sm:p-6 bg-white/10 
                    ...
                    >
                      ...
                      <header className="flex items-start gap-4">
                        <div className="relative">
                          <div className="grid h-12 w-12 place-items-center rounded-xl ring-1 ring-white/30 shadow-xl bg-[radial-gradient(120%_120%_at_30%_25%,rgba(255,255,255,0.9)_0%,rgba(255,255,255,0.35)_25%,rgba(255,255,255,0.08)_60%,rgba(0,0,0,0.14)_100%),radial-gradient(100%_100%_at_70%_75%,#2563eb_0%,#1d4ed8_60%)]">
                      ...
                      <ul className="mt-4 space-y-2">
                        {service.features.map((feature: string) => (
                          <li
                            key={feature}
                            className="flex items-center gap-2 text-white/85 text-xs sm:text-sm"
                          >
